...
const updatePost = (state, updatedPost) => ({
  ...
  usersPosts: {
    ...state.usersPosts,
    data: state.usersPosts && state.usersPosts.data &&
      state.usersPosts.data.map(post => post.id === updatedPost.id ? updatedPost : post)
  },
  likedPosts: {
    ...state.likedPosts,
    data: state.likedPosts && state.likedPosts.data &&
      state.likedPosts.data.map(post => post.id === updatedPost.id ? updatedPost : post)
  },
  feedPosts: {
    ...state.feedPosts,
    data: state.feedPosts && state.feedPosts.data &&
      state.feedPosts.data.map(post => post.id === updatedPost.id ? updatedPost : post)
  },
  archivePosts: {
    ...state.archivePosts,
    data: state.archivePosts && state.archivePosts.data &&
      state.archivePosts.data.map(post => post.id === updatedPost.id ? updatedPost : post)
  },
  savedPosts: {
    ...state.savedPosts,
    data: state.savedPosts && state.savedPosts.data &&
      state.savedPosts.data.map(post => post.id === updatedPost.id ? updatedPost : post)
  },
